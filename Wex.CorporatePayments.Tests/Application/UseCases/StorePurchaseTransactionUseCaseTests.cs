...
public class StorePurchaseTransactionUseCaseTests
{
    ...
    public async Task HandleAsync_WithUniqueConstraintViolation_ShouldThrowIdempotencyConflictException()
    {
        ...
        var dbUpdateException = new DbUpdateException("Database update failed", sqliteException);
    ...
    {
        // Arrange
        var dbUpdateException = new DbUpdateException("Database update failed", null);
